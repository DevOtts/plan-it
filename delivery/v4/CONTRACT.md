...
Version: **v1.3 — FROZEN 2026-09-07** (AMD-7, AMD-8 and AMD-10 applied by the orchestrator during W1, see Changelog; v1.0 (ratified by Fernando Ott at PLAN-REVIEW, gate G4, 2026-09-07: defaults R1–R12 confirmed as applied; authorizations A-1, A-3, A-4 granted; A-2 held until owner action O-2. Drafted as v1.0-draft, amended to v1.1-draft after squad planning, ratified to v1.0 — see Changelog. Post-freeze changes only via dated `AMD-n` entries in `delivery/decisions.md`.)
